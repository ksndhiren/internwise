  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium font-body ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        coral: "bg-coral text-primary-foreground hover:bg-coral-hover rounded-full font-semibold shadow-lg shadow-coral/25 hover:shadow-xl hover:shadow-coral/30",
        "coral-sm": "bg-coral text-primary-foreground hover:bg-coral-hover rounded-full font-semibold",
        "ghost-hero": "bg-white/10 text-primary-foreground border border-white/20 backdrop-blur-sm hover:bg-white/20 rounded-full font-semibold",
        "navy-outline": "border-2 border-navy text-navy hover:bg-navy hover:text-primary-foreground rounded-full font-semibold",
        navy: "bg-navy text-primary-foreground hover:bg-navy-dark rounded-full font-semibold",
      },
      size: {
